...
int main()
{
    ...
    Mat car_image = imread(R"(C:\Users\sebastian\Desktop\Szkola\NAItmp\9\car0.png)");
    Mat car_image2 = imread(R"(C:\Users\sebastian\Desktop\Szkola\NAItmp\9\car1.png)");
    Mat goal_image = imread(R"(C:\Users\sebastian\Desktop\Szkola\NAItmp\9\obstacle.png)");
    ...
    while (waitKey(10) != 27) {
        ...
        putText(detected, "Score: " + to_string(points), Point(10, 50), FONT_HERSHEY_SIMPLEX, 2, Scalar(0, 0, 255), 2);
        putText(detected, "Score: " + to_string(points2), Point(10, 475), FONT_HERSHEY_SIMPLEX, 2, Scalar(0, 255, 0), 2);
    ...
    if(points > points2){
        cout << "Red car 1st with: " << points << " points" << endl;
        cout << "Green car 2nd with: " << points2 << " points" << endl;
    }
    else if(points < points2){
        cout << "Green car 1st with: " << points2 << " points" << endl;
        cout << "Red car 2nd with: " << points << " points" << endl;
    }
    else{
